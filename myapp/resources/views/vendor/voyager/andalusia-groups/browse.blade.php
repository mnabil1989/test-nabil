                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="actions text-right">{{ __('status') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input data-id="{{$data->id}}" class="toggle-class" type="checkbox"
                                                   ...
                                                   data-on="Yes" data-off="No" {{ $data->status ? 'checked' : '' }}>
                                        </td>
        ...
        $(function () {
            $('.toggle-class').change(function () {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: 'andalusiagroup/changeStatus',
                    data: {'status': status, 'id': id},
                    success: function (data) {
                        toastr.success("success Updated Status on Andalusia Group");
                    }
                });
            })
        })
