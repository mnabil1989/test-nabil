            ...
            <div class="profile-sidebar">
              ...
              <div class="dashboard-widget">
                <nav class="dashboard-menu">
                  <ul>
                    <li>
                      <nuxt-link :to="localePath('/person/profile-settings')">
                        <i class="fas fa-user-cog"></i>
                        <span>Profile Settings</span>
                      </nuxt-link>
                    </li>
                    <li>
                      <nuxt-link :to="localePath('/person/change-password')">
...
export default {
  ...
  methods: {
    ...
    handleJoin() {
      ...
      this.$router.push(this.localePath(`/user/person/sd/${this.channel}`));
      // ${this.user_id}
    }
  },
  mounted() {
