            ...
            <div class="profile-sidebar">
              ...
              <div class="dashboard-widget">
                <nav class="dashboard-menu">
                  <ul>
                    <li>
                      <nuxt-link :to="localePath(`/${$route.params.bu}/person/profile-settings`)">
                        <i class="fas fa-user-cog"></i>
                        <span>Profile Settings</span>
                      </nuxt-link>
                    </li>
                    <li>
                      <nuxt-link :to="localePath(`/${$route.params.bu}/person/change-password`)">
  ...
  methods: {
    ...
    handleJoin() {
      ...
      let objectClient = {
        ...
        user_id: "1010101010",
        token:
          "006193d6f008e9e43b2b9a3655808daed7dIACm/xInmErzPNxPMJyx/dmsHO69HaE0GyNSK+UVyxa4Mwx+f9jXlvFJIgCH+iujmQqDXgQAAQApx4FeAgApx4FeAwApx4FeBAApx4Fe",
      ...
      this.$router.push(this.localePath(`/${this.$route.params.bu}/user/person/sd/${this.channel}`));
      // ${this.user_id}
    }
  },
  mounted() {
