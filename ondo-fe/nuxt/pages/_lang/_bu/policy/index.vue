<template>
  <div class="policy">
    <!-- Breadcrumb -->
    <breadcrumb :link-to="'Home'" :current-page="'Policy'"></breadcrumb>
    <!-- /Breadcrumb -->
    ...
    <div class="content">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="terms-content" v-html="$i18n.locale==='ar'?policy.privacy_policy_ar:policy.privacy_policy"></div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  head(){
    return{
      title: "Andalusia Dot Care | Policy",
      link: [
        {
          rel: "stylesheet",
          href: `/${this.style}.css`
