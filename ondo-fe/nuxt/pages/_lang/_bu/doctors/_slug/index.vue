<template>
  <div class="main-wrapper">
    ...
    <!-- Breadcrumb -->
    <breadcrumb :link-to="'Home'" :current-page="'Doctor Profile'"></breadcrumb>
    <!-- /Breadcrumb -->
            ...
            <div class="doctor-widget">
              <div class="doc-info-left">
                ...
                <div class="doc-info-cont">
                  ...
                  <p class="doc-department">{{doctor.position}}</p>
                ...
                <div class="doc-info-right">
                  ...
                  <div class="clinic-booking">
                    <nuxt-link
                      class="apt-btn"
                      :to="localePath(`/${$route.params.bu}/doctors/${doctor.slug}/appointment`)"
          ...
          <div class="card">
            <div class="card-body pt-0">
              ...
              <nav class="user-tabs mb-4">
                <ul class="nav nav-tabs nav-tabs-bottom nav-justified" style="padding: 0">
                  <li class="nav-item">
                    <a
                  ...
                  <div class="row">
                    <div class="col-md-12 col-lg-9">
                      ...
                      <div class="widget about-widget">
                        <h4 class="widget-title">{{$t('About Doctor')}}</h4>
                        ...
                        <div class="clinic-content">
                          ...
                          <div class="clinic-details mb-0">
                            <p class="clinic-direction">
                              <i class="fas fa-map-marker-alt"></i> 2883 University Street, Seattle, Texas Washington,
                              98155
                              <br />
                              <a href="javascript:void(0);">Get Directions</a>
                            </p>
...
export default {
  ...
  async asyncData(context) {
    ...
    let doctorsResponse = await context.$axios.get(
      `/${context.params.bu}-api/doctor/${encodeURIComponent(
        context.route.params.slug
      )}?lang=${context.app.i18n.locale}`
    );
    return { doctor: doctorsResponse.data.doctor };
  },
  created() {
