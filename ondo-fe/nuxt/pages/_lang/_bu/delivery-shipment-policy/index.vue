<template>
  <div class="policy">
    <!-- Breadcrumb -->
    <breadcrumb :link-to="'Home'" :current-page="'delivery shipment policy'"></breadcrumb>
    <!-- /Breadcrumb -->
    ...
    <div class="content">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="terms-content" v-html="$i18n.locale==='ar'? policy.delivery_shipment_policy_ar :policy.delivery_shipment_policy"></div>
          </div>
        </div>
      </div>
    </div>
