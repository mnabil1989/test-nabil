          ...
          <div class="col-md-12 col-12">
            <nav aria-label="breadcrumb" class="page-breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{$t('Profile Settings')}}</li>
              </ol>
            </nav>
            <h2 class="breadcrumb-title">{{$t('Profile Settings')}}</h2>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    updateProfile(updateInfo) {
      ...
      axios
        .put("/api/update-profile", updateInfo, {
