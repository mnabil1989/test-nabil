...
export const mutations = {
    ...
    setAttachment(state, attachments) {
        state.bookInfo.attachments = attachments;
    },
...
export const getters = {
    ...
    getAttachment: (state) => {
        return state.bookInfo.attachments
    }
}
...
export const actions = {
    ...
    setAttachment({ commit }, attachments) {
        commit('setAttachment', attachments)
    }
}
