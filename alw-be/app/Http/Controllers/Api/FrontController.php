...
class FrontController extends Controller
{
    ...
    {
        $data = ['about_us_en' => null,
                'about_us_ar' => null,
                'about_us_small_en' => null,
                'about_us_small_ar' => null,
                'image' => null,'image_title' => null,
                'image_alt' => null,
                'home_about_us_video' => null,
                'branch_one_ar' => null,
                'branch_one_en' => null,
                'branch_two_ar' => null,
                'branch_two_en' => null];
    ...
    {
        $data = ['home_background_video' => null, 'our_services_background' => null, 'our_consultation_background' => null];
        ...
        foreach ($Setting as $SiteSettings) {
            ...
            // echo "</pre>";die;
            if( !empty($SiteSettings->value) && $SiteSettings->type=='file' ){
                $datalink=$SiteSettings->value;
            ...
            elseif( !empty($SiteSettings->value) && $SiteSettings->type!='file' ){
                $data[str_replace("site.", "", $SiteSettings->key)] = $SiteSettings->value;
            }

            if($SiteSettings->type=='image' && !empty($SiteSettings->value) ){
                $data[str_replace("site.", "", $SiteSettings->key)] = url('/storage/'.$SiteSettings->value);
            }
