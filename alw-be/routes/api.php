...
Route::group([
    ...
    Route::get('all_doctors', 'Api\DoctorController@all_doctors');
    ...
    Route::get('topoffers', 'Api\OfferController@topoffers');
    Route::get('banneroffer', 'Api\OfferController@banneroffer');    
    Route::get('post/{slug}', 'Api\PostController@post');
    Route::get('all_posts', 'Api\PostController@all_posts');
    Route::get('most_viewed', 'Api\PostController@most_viewed');
    ...
    Route::post('search_data', 'Api\FrontController@search_data');
    ...
    Route::get('homepage', 'Api\FrontController@homepage');
