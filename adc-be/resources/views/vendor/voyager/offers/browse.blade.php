            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                                    ...
                                    <div class="col-2">
                                        <select id="search_key" name="key">
                                            @foreach($searchNames as $key => $name)
                                                <option
                                                    value="{{ $key }}" @if($search->key == $key || (empty($search->key) && $key == $defaultSearchKey)){{ 'selected' }}@endif>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-2">
                                        <select id="filter" name="filter">
                                            ...
                                            <option
                                                value="equals" @if($search->filter == "equals"){{ 'selected' }}@endif>=
                                            </option>
                                        </select>
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="actions text-right">{{ __('Top offer') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input data-id="{{$data->id}}" class="toggle-class" type="checkbox"
                                                   ...
                                                   data-on="Yes" data-off="No" {{ $data->top_offer ? 'checked' : '' }}>
                                        </td>
                        ...
                        @if ($isServerSide)
                            <div class="pull-left">
                                <div role="top_offer" class="show-res" aria-live="polite">{{ trans_choice(
    ...
    <script>
        $(function () {
            $('.toggle-class').change(function () {
                var top_offer = $(this).prop('checked') == true ? 1 : 0;
                var id = $(this).data('id');

                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: 'offer/changetop_offer',
                    data: {'top_offer': top_offer, 'id': id},
                    success: function (data) {
                        toastr.success("success Updated top_offer on service");
                        // alert(data.success)
                    }
                });
            })
