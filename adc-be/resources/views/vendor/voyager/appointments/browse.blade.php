        ...
        <div class="row">
            ...
            <select id="selectDoctorBox" name="doctorId"  class="fc-today-button fc-button fc-button-primary" onchange="filterDocotrFunc()">
                ...
                @foreach($model as $doctor)
                    ...
                    @if(!in_array($doctor->doctorId->title,$doctorList))
                <option value="{{$doctor->doctorId->id}}">{{$doctor->doctorId->title}}</option>
                     @php ($doctorList[$doctor->doctorId->id] = $doctor->doctorId->title)
                    @endif
                  @endforeach
                <option value="">List All...</option>
            </select> 
