...
class AndalusiaGroupController extends Controller
{
    ...
    {
        $andlGroup = AndalusiaGroup::find($request->id);
        $andlGroup->status = $request->status;
        $andlGroup->save();

        return response()->json(['success'=>'Andalusia status change successfully.']);
    }
}
