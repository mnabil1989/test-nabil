...
class AuthController extends Controller
{
     ...
     *     @OA\JsonContent(
     *       type="object",
     *       required={"name","phone","email", "password","password_confirmation","government_id"},
     *     @OA\Property(
     *         property="name",
     *         type="string",
     *         example="user",
    ...
    public function register(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'government_id' => 'required|integer| min:10'
        ]);
...
//        dd($doctor);
    ...
    public function handleProviderCallbackMobileLogin(Request $request)
    {
        ...
        if ($code == 523) {
            ...
            return response()->json('Not Registered', 404);
        } else {
