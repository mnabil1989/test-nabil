...
use App\SiteSetting;
class VoyagerSiteSettingsController extends Controller
{
    public function index()
    {
        ...
        $data = SiteSetting::orderBy('order', 'ASC')->get();
        ...
        $groups_data = SiteSetting::select('group')->distinct()->get();
        $groups = [];
        ...
        return view('vendor.voyager.sitesettings.index', compact('settings', 'groups', 'active'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $key_check = SiteSetting::where('key', $key)->get()->count();
        ...
        $lastSetting = SiteSetting::orderBy('order', 'DESC')->first();
        ...
        SiteSetting::create($request->except('setting_tab'));
